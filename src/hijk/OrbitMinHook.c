...
BOOL CreatePrologFunction(PTRAMPOLINE ct, LPVOID pPrologCallback, LPVOID pEpilogCallback)
{
    ...
    memcpy( &pProlog[orbitProlog->m_Offsets[Prolog_CallbackAddress]], &pPrologCallback,      sizeof(LPVOID) );
    ...
    memcpy( &pEpilog[orbitEpilog->m_Offsets[Epilog_CallbackAddress]], &pEpilogCallback,  sizeof(LPVOID) );
